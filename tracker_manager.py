...
class TrackerManager:
    def __init__(self, tracker_type='kcf', use_CF=True, tracked_ID={}, **kwargs):
    ...
    def init_trackers(self, frame, boxes):
        ...
        if self.use_CF:
            self.__init_tracker_with_CF(frame, boxes)
        else:
            self.__init_tracker_without_CF(frame, boxes)
    ...
    def __init_tracker_without_CF(self, frame, boxes):
